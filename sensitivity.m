...
figure('Position',[100 500 1800 1200])
...
hline4 = plot(time, infect(ar21), 'color', colors(5,:), 'LineWidth', 2); 
...
hline5 = plot(time, infect(ar20), 'color', colors(4,:), 'LineWidth', 2);
hold off
...
lh = legend([hline1 hline2 hline3 hline5 hline4], '10 \mug/mL', '1 \mug/mL', '100 ng/mL', '10 ng/mL', '1 ng/mL to .01 pg/mL', 2);
set(lh, 'FontSize', 14)
...
hline5 = plot(time, infect(sb21), 'color', colors(5,:), 'LineWidth', 2); 
...
lh = legend([hline1 hline2 hline3 hline4 hline5], '10 \mug/mL', '1 \mug/mL', '100 ng/mL', '10 ng/mL', '1 ng/mL to .01 pg/mL', 2);
set(lh, 'FontSize', 14)
...
hline5 = plot(time, infect(wb21), 'color', colors(5,:), 'LineWidth', 2); 
