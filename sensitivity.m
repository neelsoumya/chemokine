...
legend([hline1 hline2 hline3 hline5 hline4], '10 \mug/mL', '1 \mug/mL', '100 ng/mL', '10 ng/mL', '1 ng/mL to .01 pg/mL', 2)
...
hline3 = plot(time, infect(sb19), 'color', colors(5,:), 'LineWidth', 2);
...
legend([hline1 hline2 hline4 hline3], '10 \mug/mL', '1 \mug/mL', '10 ng/mL', '100 ng/mL to .01 pg/mL', 2)
...
hline3 = plot(time, infect(wb19), 'color', colors(5,:), 'LineWidth', 2);
