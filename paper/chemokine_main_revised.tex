...
%The adaptive immune response to influenza A infection in the lung requires a complex combination of different defensive mechanisms.  CD8 T cells must navigate from the lymph node through the vascular system to the site of infection.  
%
%
%The high replication rate of 2009 pandemic H1N1 influenza presents unique challenges to the immune system when compared to other strains of influenza.  Studies have attributed the high mortality rate of hosts infected with pH1N1 to the virus' high replication rate.
%
%We suggest pH1N1 virulence may only tell part of the story.  Static analysis of viral production rates and plaque sizes ignore the spatial structure of the infection.  We ask how small foci of infected tissue, scattered through a very large space of uninfected tissue, can attract and retain appropriate numbers of activated CD8 T cells.  
%
%There are many mathematical models of the adaptive response \cite{Miao2010, Saenz2010, Beltman2007, Handel2008, Zheng2008, Lee2009}, filling gaps with reasonable assumptions of cellular behavior in the absence of experimental support.  Models using ordinary differential equations are able to predict events with temporal fidelity, but lack the ability to examine the spatial detail \cite{Beauchemin2006a, Bauer2009}.   Here we examine spatial aspects of the the CD8 T cell diaspora and recruitment to infected lung.  Activated CD8 T cells searching for and homing into infected tissue do so in a complex environment.  We therefore used agent-based modeling (ABM) to represent the physical environment of the searching T cell.  In the model, CD8 T cells travel in vascular and lymphatic channels during part of their search, and respond to localized inflammatory signals to achieve compartmentalized cell-cell interactions.  
%
%%Therefore, we constructed a spatial agent-based model to examine how T cells are recruited to the site of infection, and once there, how they navigate over the plaque to contain the growing infection.  Because our model strives to answer the specific questions regarding T cell recruitment and movement in the lung, we ignore other important aspects of the immune response such as...
%
%% Our model does not consider important features of tissue immunity such as T cell proliferation, resident T cells, and regulatory interactions with other cell phenotypes \cite{McGill2009}.  The model does not aim to predict control of viral replication but only to compare simulated outcomes among three influenza strains arising from the efficacy of the chemotactic signals.  
%
%Previous work has shown that T cell search is likely aided by chemokine secretion by infected cells \cite{Banerjee2011}, but details of this process are unknown.  To find secretion rates of chemokines, we infected human epithelial cells \textit{in virto} with one of three strains of influenza: avian aH5N1, seasonal sH1N1, and pandemic 2009 pH1N1.  Wells were measured  for specific chemokines at specific time points over a period of two days.  Two chemokines: IP-10 (CXCL10) and RANTES (CCL5) displayed elevated concentrations over the course of the infections.  We extended a previous ODE model \cite{Mitchell2011} and fit it to the chemokine data to deduce per cell chemokine production rates.  We then used the resulting values to inform our spatial model of T cell recruitment.
%
%Our results reveal unique spatial challenges to T cell search that arise from chemokine recruitment of T cells to the site of infection.  Molecular diffusion of chemokines creates the chemical gradients that allow T cells to find the infection.  Conversely, the coarse nature of the diffusion process creates pockets of high chemokine concentration.  These pockets, or local maxima, have the unfortunate effect of recruiting and trapping T cells that navigate within their basin of attraction.  This effect hinders the ability of T cells to properly cover the entire infection.  We find that viruses with very high replication rates, such as pandemic H1N1, can create infections that spread across tissue faster than the chemokine signals can diffuse.  In these instances, the chemical signal that is so crucial to T cell recruitment will actually hinder the immune system's search process.
%
%These results show interventions that increase chemokine concentrations and T cell counts may not help clear an infection.  Furthermore, clearing the pH1N1 infection may be limited by the rate at which T cells can kill infected epithelial cells.  This suggests that early interventions to infection, such as vaccination, may be the only way to avoid runaway infection.
