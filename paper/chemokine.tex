...
\begin{figure}[ht!]
\begin{center}
\includegraphics[width=0.6\textwidth]{SystemChart}
\end{center}
...
\end{center}
\caption{A visual representation of the model.  Healthy epithelial cells are infected by virus.  These infected cells secrete more virus after an incubation delay.  T-cells are activated in the lymph node and traverse the bronchial vascular network to the site of infection where they are recruited by inflammatory cytokine.  Once inside the lung tissue, T-cells climb the chemokine gradient and induce apoptosis in infected cells.}
